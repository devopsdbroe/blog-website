					...
					<div className="md:max-w-md lg:col-span-2 lg:mt-0 mt-5">
						...
						<form className="mt-4 flex flex-col md:flex-row">
							<input
								...
								name="email"
								id="email"
								className="flex-grow w-full h-12 px-4 mb-3 transition duration-2 bg-white border border-gray-300 rounded shadow-sm appearence-auto md:mr-2 md:mb-0 focus:border-purple-400 focus:outline-none"
							/>
							<button
								type="submit"
